			...
			<div className="projCont animated flipInX">
				<div className="proj">
					...
					<div className="projDescription">
						<p>
							My take on a Classic Memory game using Vanilla
							Javascript
						</p>
					</div>
					<a
				...
				<div className="proj">
					...
					<div className="projDescription">
						<p>
							Join Cherry as she goes around Denmark exploring
							different places
						</p>
					</div>
					<a
						href="https://kearledc.gitlab.io/cherryblog/"
						target="_blank"
					>
						<button> Visit Denmark! </button>
					</a>
				...
				<div className="proj flipInX">
					...
					<div className="projDescription">
						<p>
							An Online Store Asset Management system Integrated
							with Paypal
						</p>
					</div>

					<a href="http://nanaystore.herokuapp.com/products">
						<button> Visit Nanay's</button>
					</a>
					<h4>Skills Utilized:</h4>
					<Tag.Group className="skillsUtilized animated pulse infinite">
